...
public class Attributes
{
    ...
    public Attributes(Texture2D texture, Rectangle sourceRectangle, AttributeType type, Vector2 relativePosition,
    ...
    public void Update(Vector2 soulPosition, Vector2 mousePosition)
    {
        ...
        Rectangle attributeRect = new Rectangle((int)_absolutePosition.X, (int)_absolutePosition.Y,
    ...
    public void Draw(SpriteBatch spriteBatch)
    {
        ...
        {
            Rectangle glowRectangle = new Rectangle((int)_absolutePosition.X - 5, (int)_absolutePosition.Y - 5,
                _sourceRectangle.Width + 10, _sourceRectangle.Height + 10);
